...
import { MapPin, Phone, FileText, Download, AlertCircle, Wrench, ShieldAlert } from "lucide-react";
          ...
          <CardContent className="pt-8 grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="space-y-4">
              ...
              <div className="flex flex-wrap gap-2">
                <Badge variant="secondary">2 Bedrooms</Badge>
                <Badge variant="secondary">Air Conditioned</Badge>
                <Badge variant="secondary">High Speed WiFi</Badge>
              </div>
            </div>
            <div className="space-y-4">
