...
export default function LandlordDashboard() {
  const stats = [
    ...
    { label: 'Active Tenants', value: 4, icon: Users, color: 'text-violet-600', bg: 'bg-violet-50' },
              ...
              <div key={request.id} className="flex items-start gap-4 p-4 rounded-xl bg-muted/30 hover:bg-muted/50 transition-colors">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="flex items-center gap-4 text-xs font-medium text-muted-foreground">
                    ...
                    <span className="flex items-center"><Clock className="w-3 h-3 mr-1" /> 2 hours ago</span>
                  </div>
                </div>
              </div>
            ))}
