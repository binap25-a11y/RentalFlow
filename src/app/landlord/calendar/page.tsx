        ...
        <DialogContent className="rounded-[2.5rem] border-none shadow-2xl p-0 overflow-hidden max-w-[550px] bg-card flex flex-col h-[850px] max-h-[95vh] ring-1 ring-white/10">
          ...
          <DialogFooter className="p-6 bg-muted/5 border-t border-white/5 shrink-0">
            <Button 
              ...
              className="w-full rounded-xl h-11 font-bold bg-background text-foreground border border-border shadow-2xl shadow-primary/20 hover:bg-primary hover:text-primary-foreground transition-all font-headline uppercase tracking-widest text-[10px] hover:scale-[1.01]"
            >
      ...
      <div className={cn("flex items-start gap-5 text-left min-w-0", compact ? "w-full" : "flex-1 items-center")}>
        ...
        <div className="min-w-0 flex-1">
          <div className="flex items-center gap-2 mb-1">
             ...
             <span className="text-[9px] font-bold text-muted-foreground uppercase opacity-40 font-headline">
