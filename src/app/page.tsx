      ...
      <nav className="fixed top-0 w-full z-50 bg-background/80 backdrop-blur-xl border-b border-border/50 h-20">
        <div className="max-w-7xl mx-auto h-full px-6 flex items-center justify-between">
          <div className="flex items-center gap-3">
             ...
             <span className="font-headline font-bold text-2xl tracking-tight text-foreground">RentalFlow</span>
          </div>
          ...
          <div className="flex items-center gap-4">
             {user ? (
               ...
               <>
                 <Button variant="ghost" asChild className="rounded-xl font-bold text-foreground hidden sm:inline-flex">
                   <Link href="/auth">Sign In</Link>
                 </Button>
                 <Button asChild className="rounded-xl font-bold bg-primary shadow-xl shadow-primary/20 text-primary-foreground px-6">
      ...
      <section id="features" className="py-32 bg-muted/30">
        <div className="max-w-7xl mx-auto px-6 text-center space-y-20">
          <div className="max-w-3xl mx-auto space-y-4">
             <h2 className="text-4xl md:text-5xl font-headline font-bold text-foreground tracking-tight">Engineered for Operational Excellence</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <Card className="border-none shadow-sm rounded-[2.5rem] p-10 bg-card hover:shadow-2xl transition-all group text-left">
              <div className="p-5 bg-emerald-500/10 text-emerald-600 rounded-3xl w-fit mb-8 group-hover:scale-110 transition-transform">
        ...
        <div className="max-w-7xl mx-auto px-6 flex flex-col lg:flex-row items-center gap-20">
          <div className="flex-1 text-left space-y-10">
             <div className="space-y-4">
                ...
                <p className="text-xl text-slate-300 font-medium leading-relaxed">RentalFlow combines Firebase's secure real-time architecture with PostgreSQL redundancy to protect your portfolio data.</p>
             </div>
          ...
          <div className="flex-1 w-full max-w-md">
             <div className="bg-white rounded-[3rem] p-8 shadow-2xl relative overflow-hidden">
                ...
                <div className="flex items-center justify-between mb-8">
                   <p className="text-[10px] font-bold uppercase tracking-widest text-slate-400">Portfolio Pulse</p>
                ...
                <div className="space-y-6">
                   ...
                   <div className="pt-4 border-t border-slate-100 space-y-4">
                      <div className="flex justify-between items-center">
                         <span className="text-xs font-bold text-slate-900">Yield Potential</span>
                         <span className="text-xs font-bold text-emerald-600">£12,450 /mo</span>
                      </div>
                      <div className="w-full h-2 bg-slate-100 rounded-full overflow-hidden">
                         <div className="w-[85%] h-full bg-[#1e3a8a]" />
                      </div>
                   </div>
                </div>
             </div>
      ...
      <footer className="py-12 border-t border-border">
        <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row justify-between items-center gap-6">
          <div className="flex items-center gap-3">
             ...
             <span className="font-headline font-bold text-lg tracking-tight text-muted-foreground">RentalFlow</span>
          </div>
