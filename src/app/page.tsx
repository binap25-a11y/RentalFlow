...
import { 
  ...
  Globe, Zap, LayoutDashboard, CheckCircle2, Loader2
} from "lucide-react";
  ...
  return (
    <div className="min-h-screen bg-background font-body selection:bg-primary selection:text-primary-foreground overflow-x-hidden text-left">
      <nav className="fixed top-0 w-full z-50 bg-background/80 backdrop-blur-xl border-b h-20">
        <div className="max-w-7xl mx-auto h-full px-6 flex items-center justify-between">
          <div className="flex items-center gap-3">
             ...
             <span className="font-headline font-bold text-2xl tracking-tighter">RentalFlow</span>
          </div>
          <div className="flex items-center gap-4">
             {user ? (
               <Button asChild className="rounded-xl font-bold bg-accent text-accent-foreground px-6 h-11 shadow-lg shadow-accent/20">
               ...
               <>
                 ...
                 <Button asChild className="rounded-xl font-bold bg-accent text-accent-foreground px-6 h-11 shadow-lg shadow-accent/20"><Link href="/auth">Get Started</Link></Button>
               </>
             )}
          </div>
        </div>
      ...
      <section className="relative pt-40 pb-32">
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
          <div className="text-left space-y-8 animate-in fade-in slide-in-from-bottom-8 duration-1000">
            ...
            <div className="pt-4">
              {user && profile ? (
                <Button size="lg" asChild className="h-16 px-10 rounded-2xl bg-accent text-accent-foreground text-lg font-bold shadow-2xl hover:scale-[1.02] transition-transform">
                  <Link href={profile.role === 'landlord' ? '/landlord/properties' : '/tenant/hub'}>
            ...
            <p className="text-xl text-muted-foreground font-medium max-w-xl leading-relaxed">
              Accelerate your rental operations with automated maintenance triage and professional ledger tracking.
            </p>
          </div>
      ...
      <section id="features" className="py-32 bg-muted/30">
        <div className="max-w-7xl mx-auto px-6 text-center space-y-20">
          <div className="max-w-3xl mx-auto space-y-4">
             <h2 className="text-4xl md:text-5xl font-headline font-bold tracking-tight">Engineered for Excellence</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <Card className="border-none shadow-sm rounded-[2.5rem] p-10 bg-card hover:shadow-2xl transition-all group text-left">
              ...
              <h3 className="text-2xl font-bold font-headline mb-4">AI Maintenance Triage</h3>
            ...
            <Card className="border-none shadow-sm rounded-[2.5rem] p-10 bg-card hover:shadow-2xl transition-all group text-left">
              ...
              <h3 className="text-2xl font-bold font-headline mb-4">Financial Command</h3>
              <p className="text-muted-foreground font-medium leading-relaxed">Unified rental ledgers with real-time status tracking and professional PDF statements.</p>
            </Card>
            <Card className="border-none shadow-sm rounded-[2.5rem] p-10 bg-card hover:shadow-2xl transition-all group text-left">
              ...
              <h3 className="text-2xl font-bold font-headline mb-4">Resident Concierge</h3>
      ...
      <section className="py-32">
        <div className="max-w-4xl mx-auto px-6 text-center bg-muted/30 rounded-[4rem] p-10 md:p-20 space-y-10 border">
           ...
           {user ? (
             <Button size="lg" asChild className="h-16 px-12 rounded-2xl bg-accent text-accent-foreground text-xl font-bold shadow-2xl">
