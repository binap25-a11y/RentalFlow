...
function Calendar({
  ...
  return (
    <DayPicker
      ...
      className={cn("p-6 bg-card rounded-[2.5rem] shadow-sm ring-1 ring-border", className)}
      classNames={{
        months: "flex flex-col sm:flex-row space-y-4 sm:space-x-4 sm:space-y-0",
        month: "space-y-6",
        month_caption: "flex justify-center pt-1 relative items-center mb-6 h-10",
        caption_label: "text-lg font-bold font-headline text-foreground tracking-tight",
        nav: "space-x-1 flex items-center",
        button_previous: cn(
          "h-9 w-9 bg-transparent p-0 opacity-40 hover:opacity-100 absolute left-1 z-10 rounded-xl border border-border shadow-sm transition-all flex items-center justify-center cursor-pointer hover:bg-accent/10 hover:text-accent hover:border-accent/20"
        ),
        button_next: cn(
          "h-9 w-9 bg-transparent p-0 opacity-40 hover:opacity-100 absolute right-1 z-10 rounded-xl border border-border shadow-sm transition-all flex items-center justify-center cursor-pointer hover:bg-accent/10 hover:text-accent hover:border-accent/20"
        ),
